<template lang="">
    <div>
        ...
        <ul>
            ...
            <li><router-link to="/example/datetimeluxon">DatetimeLuxon</router-link></li><br>
            <li><router-link to="/example/filterdatawithoutcomputed">Filterdatawithoutcomputed</router-link></li><br>
            <li><router-link to="/example/filterdatawithcomputed">Filterdatawithcomputed</router-link></li><br>
            <li><router-link to="/example/propsfilterdata">Propsfilterdata</router-link></li><br>
            <li><router-link to="/example/storedata">Storedata</router-link></li><br>
